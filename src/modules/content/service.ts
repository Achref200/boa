...
export const getActiveAnnouncement = (locale: AppLocale) =>
  unstable_cache(() => withDbFallback(null, () => fetchAnnouncement(locale)), ['announcement', locale], {
    tags: [CONTENT_TAG],
    revalidate: 300,
  })();

export const getPageBlocks = (locale: AppLocale, page = 'home') =>
  unstable_cache(() => withDbFallback([], () => fetchBlocks(locale, page)), ['blocks', locale, page], {
    tags: [CONTENT_TAG],
    revalidate: 300,
  })();
